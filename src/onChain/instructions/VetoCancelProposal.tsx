...
export const VetoCancelProposal: FC = () => {
    ...
    const config = PublicKey.findProgramAddressSync(
      ...
      toast.success("Veto Cancelled the Proposal successfully!! Transaction ID: " + signature);
