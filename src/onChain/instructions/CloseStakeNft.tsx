...
const collection_mint = new PublicKey('7sDdmHw7Stsw3c26Uxnt3oY1rvDNcLuyfkh5Fcu3mBpJ');
...
export const UnStakeNft: FC = () => {
    ...
    const onClick = useCallback(async () => {
        try {
            ...
            toast.success("Closed Stake State nft successfully! Transaction ID: " + signature);
