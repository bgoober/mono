...
export const CleanupVote: FC = () => {
  ...
  const getProvider = () => {
    ...
    const treasury = PublicKey.findProgramAddressSync(
      ...
      toast.success("Cleaned Vote successfully!! Transaction ID: " + signature);
            ...
            <div className="relative group items-center">
                ...
                >
                    ...
                    <span className="block group-disabled:hidden" > 
                        Clean Vote If proposal has expired.
                        To unlock voting power amount
                    </span>
                </button>
            </div>
        </div>
